...
class CalendarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post calendars_url, params: { calendar: { foreign_id: @calendar.foreign_id, name: @calendar.name, url: @calendar.url } }
    end
  ...
  test "should update calendar" do
    patch calendar_url(@calendar), params: { calendar: { foreign_id: @calendar.foreign_id, name: @calendar.name, url: @calendar.url } }
